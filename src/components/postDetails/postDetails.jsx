...
import { getPostDetails } from "../../Api/singlePost.api";
...
export default function PostDetails() {
  ...
  return (
    <>
      <div className={`${theme} bg-light dark:bg-darkBg h-fit min-h-screen `}>
        <div className="">
          <div className="flex items-center justify-center ">
            <div className="bg-light dark:bg-darkLr  p-6 my-5 rounded-2xl shadow-[0_0_15px_rgba(0,0,0,0.3)] w-[90%] md:w-[60%] lg:w-[60%] xl:w-[50%]">
              {/* Post */}
